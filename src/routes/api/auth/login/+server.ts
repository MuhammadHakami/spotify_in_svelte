...
export const GET: RequestHandler = ({cookies}) => {
    cookies.set('spotify_auth_state', state, {path: BASE_URL, sameSite: 'lax'});
    cookies.set('spotify_auth_challenge_verifier', challenge.code_verifier, {path: BASE_URL, sameSite: 'lax'});
